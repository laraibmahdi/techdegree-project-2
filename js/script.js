...
const ulForButton = document.querySelector(".link-list");
 ...
 const liForNewButton = document.createElement("li");
...
for (let i=0 ; i<valueOfButtons ; i++) {
 ...
 ulForButton.addEventListener("click",(e) => {
   ...
   students(data, buttonActive.textContent);
  buttonActive.className = "active";
 if (buttonActive.tagName === "BUTTON") {
  const prevActiveButton = ulForButton.querySelector(".active");
